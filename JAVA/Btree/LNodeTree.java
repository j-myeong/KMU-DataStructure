...
public class LNodeTree {
    public static void main(String[] args) {
        BinNode<String> 교 = new LNode<>("H"); // LNode
        BinNode<String> 수 = new INode<>("E", 교, null);
        BinNode<String> 님 = new LNode<>("L"); // LNode
        BinNode<String> 사 = new INode<>("L", 수, 님);
        BinNode<String> 랑 = new LNode<>("L"); // LNode
        BinNode<String> 합 = new INode<>("D", 랑, null);
        BinNode<String> 니 = new INode<>("R", null, 합);
        BinNode<String> 다 = new LNode<>("W"); // LNode
